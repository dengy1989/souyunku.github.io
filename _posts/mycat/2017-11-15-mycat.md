...
**只需要在 MySql-Master：192.168.252.121 上执行，主从复制，会自动同步到 MySql-Slave：192.168.252.122**
...
<mycat:schema xmlns:mycat="http://io.mycat/">
    ...
    <schema name="test_schema" checkSQLschema="false" sqlMaxLimit="100">
        <table name="test_one" dataNode="dn1,dn2,dn3" rule="auto-sharding-long"/>
        <table name="test_two" dataNode="dn1,dn2,dn3" rule="auto-sharding-long"/>
        <table name="test_three" dataNode="dn1,dn2,dn3" rule="auto-sharding-long"/>
    </schema>
...
+--------+-------+-----------------+------+---------+-------+--------+---------+--------------+---------------------+-------+
| hostM1 | mysql | 192.168.252.121 | 3306 |       1 |     0 | idle   |       0 | 0,1,1        | 2017-11-15 18:19:56 | false |
| hostS2 | mysql | 192.168.252.122 | 3306 |       1 |     0 | idle   |       0 | 0,0,0        | 2017-11-15 18:19:56 | false |
+--------+-------+-----------------+------+---------+-------+--------+---------+--------------+---------------------+-------+
2 rows in set
