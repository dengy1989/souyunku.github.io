...
另外，JMM具备一些先天的有序性,即不需要通过任何手段就可以保证的有序性，通常称为happens-before原则。`<<JSR-133：Java Memory Model and Thread Specification>>`定义了如下**happens-before规则**：
...
[1]: http://www.ymq.io/images/2017/java/valatile/1.png
[2]: http://www.ymq.io/images/2017/java/valatile/2.png
