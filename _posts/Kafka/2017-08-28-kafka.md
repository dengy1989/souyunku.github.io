---
layout: post
title: 搭建 MySQL 5.7.19 主从复制，以及复制实现细节分析
categories: Kafka
description: 搭建 MySQL 5.7.19 主从复制，以及复制实现细节分析
keywords: Kafka
---

# CentOs7.3 搭建高吞吐量 Kafka 分布式发布订阅消息 集群
...
[ZooKeeper-3.4.9集群详情安装](https://segmentfault.com/a/1190000010807875)
...
Kafka使用ZooKeeper，所以先**启动ZooKeeper服务器**
...
或者后台启动运行，看不到日志，日志查看去，Kafka解压目录有个`log` 文件夹查看
